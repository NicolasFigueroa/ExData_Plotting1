...
#Create the histogram and save in file
hist(subsetElectricPowerConsumption$Global_active_power, main="Global Active Power", xlab="Global Active Power (kilowatts)", col="red")
